...
public class LoginActivity extends AppCompatActivity {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(userName)) {
                    Toast.makeText(LoginActivity.this, "还没有注册账号！",
                ...
                if (TextUtils.equals(account, userName)) {
                    if (TextUtils.equals(password, pass)) {
                        Toast.makeText(LoginActivity.this, "恭喜你，登录成功！",
                                Toast.LENGTH_LONG).show();
    ...
    private void initData() {
        ...
        String account = spf.getString("account", userName);
        String password = spf.getString("password", pass);
